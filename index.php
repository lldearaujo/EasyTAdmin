<?php 
    //Carrega a sessão global
    session_start();
    //Redireciona caso a sessão não exista
	...
	<div id="wrapper">
		...
		<div id="sidebar-wrapper">
			<ul class="sidebar-nav">
				...
				<li><a href="views/relatorios.html">Relatórios</a></li>
				<li><a href="views/configuracoes.html">Configurações</a></li>
			</ul>
		</div>
		<!-- /#sidebar-wrapper -->
		<!-- Page Content -->
					...
					<div class="row">
						...
						<div class="col-xs-6">
							<div id="tomadas" class="row vertical_div">
									...
									<h3>Saídas</h3>
									<div class="btn">
										<a href="../controller/rele.php?rele_on">
											<img src="assets/img/tomada_on.png" class="img-responsive" width="128px"/>
										</a>
									</div>
									<div class="btn">
										<a href="../controller/rele.php?rele_off">
